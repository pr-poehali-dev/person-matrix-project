  ...
  return (
    <>
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm relative overflow-hidden p-8 sm:p-10">
        <div className="absolute -top-16 -right-16 w-48 h-48 bg-[#F4F2FA] rounded-full opacity-60 pointer-events-none" />
        <div className="absolute -bottom-12 -left-12 w-36 h-36 bg-[#F9F0F4] rounded-full opacity-50 pointer-events-none" />

        <div className="relative flex flex-col sm:flex-row sm:items-center gap-6">
          <div className="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl flex items-center justify-center shrink-0 mx-auto sm:mx-0" style={{ background: "linear-gradient(135deg, #F4F2FA, #E8E4F5)" }}>
          ...
          <div className="text-center sm:text-left">
            ...
            <h2 className="font-golos text-3xl sm:text-4xl font-semibold text-gray-900 mb-1">
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="inline-flex items-center gap-1 bg-[#F4F2FA] text-[#6C5BA7] text-xs font-semibold rounded-lg px-2.5 py-1">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
        <div className="flex items-start gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl bg-[#F4F2FA] flex items-center justify-center shrink-0 mt-0.5">
            <Icon name="User" size={20} className="text-[#6C5BA7]" />
          </div>
          <div>
            <h2 className="font-golos text-xl sm:text-2xl font-semibold text-gray-900 leading-tight">
              Архетип личности
            </h2>
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
        <div className="flex items-start gap-3 mb-5">
          <div className="w-10 h-10 rounded-xl bg-[#F4F2FA] flex items-center justify-center shrink-0 mt-0.5">
            <Icon name="Hash" size={20} className="text-[#6C5BA7]" />
          </div>
          <div>
            <h2 className="font-golos text-xl sm:text-2xl font-semibold text-gray-900 leading-tight">
              Характерные черты
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <h3 className="font-golos text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          <h3 className="font-golos text-lg font-semibold text-gray-900 mb-3 flex items-center gap-2">
            <div className="w-7 h-7 rounded-lg bg-[#F4F2FA] flex items-center justify-center">
              <Icon name="Brain" size={15} className="text-[#6C5BA7]" />
            </div>
            Тип мышления
          </h3>
          <div className="mb-2">
            <span className="inline-flex items-center gap-1.5 bg-[#F4F2FA] text-[#6C5BA7] text-xs font-semibold rounded-lg px-2.5 py-1">
      ...
      <div className="rounded-2xl p-6 sm:p-8 text-center text-white bg-[#6C5BA7]">
        <Icon name="Lock" size={28} className="mx-auto mb-3 opacity-80" />
        <h3 className="font-golos text-xl sm:text-2xl font-semibold mb-2">
          Полный анализ предназначения
        </h3>
        <p className="text-white/70 text-sm max-w-lg mx-auto">
          20 разделов анализа: портрет, индексы, карьера, предназначение, отношения,
          жизненные циклы, ключевые уроки, риски, стратегия и многое другое
        </p>
      </div>
    </>
  );
