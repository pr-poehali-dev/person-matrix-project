      ...
      <section className="px-6 py-20 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {[
            ...
            { title: "Карта судьбы", subtitle: "1 490 ₽", items: ["20 разделов о личности", "Архетип и стиль мышления", "Карьера и отношения", "PDF-отчёт на 30 стр."], accent: true, btnText: "Узнать судьбу" },
            ...
            { title: "Матрица семьи", subtitle: "1 990 ₽", items: ["Анализ всей семьи", "Роли и совместимость", "Влияние на детей", "Рекомендации"], accent: false, btnText: "Анализировать" },
